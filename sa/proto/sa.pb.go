...
func (x *IncidentCert) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IncidentCert) ProtoMessage() {}

func (x *IncidentCert) ProtoReflect() protoreflect.Message {
	mi := &file_sa_proto_msgTypes[40]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IncidentCert.ProtoReflect.Descriptor instead.
func (*IncidentCert) Descriptor() ([]byte, []int) {
	return file_sa_proto_rawDescGZIP(), []int{40}
}

func (x *IncidentCert) GetSerial() string {
	if x != nil {
		return x.Serial
	}
	return ""
...
func (x *IncidentCert) GetRegistrationID() int64 {
	if x != nil {
		return x.RegistrationID
	}
	return 0
...
func (x *IncidentCert) GetOrderID() int64 {
	if x != nil {
		return x.OrderID
	}
	return 0
...
func (x *IncidentCert) GetLastNoticeSent() int64 {
	if x != nil {
...
var file_sa_proto_rawDesc = []byte{
	...
	0x22, 0x90, 0x01, 0x0a, 0x0c, 0x49, 0x6e, 0x63, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x43, 0x65, 0x72,
	...
	0x65, 0x6e, 0x74, 0x32, 0xcd, 0x15, 0x0a, 0x10, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x41,
...
var file_sa_proto_msgTypes = make([]protoimpl.MessageInfo, 44)
var file_sa_proto_goTypes = []interface{}{
	...
	(*IncidentCert)(nil),                       // 40: sa.IncidentCert
	(*ValidAuthorizations_MapElement)(nil),     // 41: sa.ValidAuthorizations.MapElement
	nil,                                        // 42: sa.CountByNames.CountsEntry
	(*Authorizations_MapElement)(nil),          // 43: sa.Authorizations.MapElement
	(*proto.Authorization)(nil),                // 44: core.Authorization
	(*proto.ProblemDetails)(nil),               // 45: core.ProblemDetails
	(*proto.ValidationRecord)(nil),             // 46: core.ValidationRecord
	(*proto.Registration)(nil),                 // 47: core.Registration
	(*proto.Certificate)(nil),                  // 48: core.Certificate
	(*proto.CertificateStatus)(nil),            // 49: core.CertificateStatus
	(*emptypb.Empty)(nil),                      // 50: google.protobuf.Empty
	(*proto.Order)(nil),                        // 51: core.Order
}
var file_sa_proto_depIdxs = []int32{
	41, // 0: sa.ValidAuthorizations.valid:type_name -> sa.ValidAuthorizations.MapElement
	8,  // 1: sa.CountCertificatesByNamesRequest.range:type_name -> sa.Range
	42, // 2: sa.CountByNames.counts:type_name -> sa.CountByNames.CountsEntry
	...
	44, // 7: sa.NewOrderAndAuthzsRequest.newAuthzs:type_name -> core.Authorization
	45, // 8: sa.SetOrderErrorRequest.error:type_name -> core.ProblemDetails
	43, // 9: sa.Authorizations.authz:type_name -> sa.Authorizations.MapElement
	44, // 10: sa.AddPendingAuthorizationsRequest.authz:type_name -> core.Authorization
	46, // 11: sa.FinalizeAuthorizationRequest.validationRecords:type_name -> core.ValidationRecord
	45, // 12: sa.FinalizeAuthorizationRequest.validationError:type_name -> core.ProblemDetails
	44, // 13: sa.ValidAuthorizations.MapElement.authz:type_name -> core.Authorization
	44, // 14: sa.Authorizations.MapElement.authz:type_name -> core.Authorization
	...
	47, // 36: sa.StorageAuthority.NewRegistration:input_type -> core.Registration
	47, // 37: sa.StorageAuthority.UpdateRegistration:input_type -> core.Registration
	...
	47, // 55: sa.StorageAuthority.GetRegistration:output_type -> core.Registration
	47, // 56: sa.StorageAuthority.GetRegistrationByKey:output_type -> core.Registration
	7,  // 57: sa.StorageAuthority.GetSerialMetadata:output_type -> sa.SerialMetadata
	48, // 58: sa.StorageAuthority.GetCertificate:output_type -> core.Certificate
	48, // 59: sa.StorageAuthority.GetPrecertificate:output_type -> core.Certificate
	49, // 60: sa.StorageAuthority.GetCertificateStatus:output_type -> core.CertificateStatus
	...
	44, // 68: sa.StorageAuthority.GetAuthorization2:output_type -> core.Authorization
	30, // 69: sa.StorageAuthority.GetAuthorizations2:output_type -> sa.Authorizations
	44, // 70: sa.StorageAuthority.GetPendingAuthorization2:output_type -> core.Authorization
	...
	47, // 76: sa.StorageAuthority.NewRegistration:output_type -> core.Registration
	50, // 77: sa.StorageAuthority.UpdateRegistration:output_type -> google.protobuf.Empty
	21, // 78: sa.StorageAuthority.AddCertificate:output_type -> sa.AddCertificateResponse
	50, // 79: sa.StorageAuthority.AddPrecertificate:output_type -> google.protobuf.Empty
	50, // 80: sa.StorageAuthority.AddSerial:output_type -> google.protobuf.Empty
	50, // 81: sa.StorageAuthority.DeactivateRegistration:output_type -> google.protobuf.Empty
	51, // 82: sa.StorageAuthority.NewOrder:output_type -> core.Order
	51, // 83: sa.StorageAuthority.NewOrderAndAuthzs:output_type -> core.Order
	50, // 84: sa.StorageAuthority.SetOrderProcessing:output_type -> google.protobuf.Empty
	50, // 85: sa.StorageAuthority.SetOrderError:output_type -> google.protobuf.Empty
	50, // 86: sa.StorageAuthority.FinalizeOrder:output_type -> google.protobuf.Empty
	51, // 87: sa.StorageAuthority.GetOrder:output_type -> core.Order
	51, // 88: sa.StorageAuthority.GetOrderForNames:output_type -> core.Order
	50, // 89: sa.StorageAuthority.RevokeCertificate:output_type -> google.protobuf.Empty
	50, // 90: sa.StorageAuthority.UpdateRevokedCertificate:output_type -> google.protobuf.Empty
	34, // 91: sa.StorageAuthority.NewAuthorizations2:output_type -> sa.Authorization2IDs
	50, // 92: sa.StorageAuthority.FinalizeAuthorization2:output_type -> google.protobuf.Empty
	50, // 93: sa.StorageAuthority.DeactivateAuthorization2:output_type -> google.protobuf.Empty
	50, // 94: sa.StorageAuthority.AddBlockedKey:output_type -> google.protobuf.Empty
